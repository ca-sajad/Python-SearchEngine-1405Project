...
import testingtools
from code import crawler, searchdata

output = open('fruits-tfidf-failed.txt', 'w')
success_output_file = open('fruits-tfidf-passed.txt', 'w')
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #0 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-128.html and word peach\n\n')
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #1 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-128.html and word banana\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #2 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-128.html and word coconut\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #3 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-128.html and word apple\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #4 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-128.html and word pear\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #5 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-128.html and word tomato\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #6 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-722.html and word peach\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #7 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-722.html and word banana\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #8 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-722.html and word coconut\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #9 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-722.html and word apple\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #10 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-722.html and word pear\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #11 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-722.html and word tomato\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #12 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-871.html and word peach\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #13 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-871.html and word banana\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #14 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-871.html and word coconut\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #15 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-871.html and word apple\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #16 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-871.html and word pear\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #17 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-871.html and word tomato\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #18 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-444.html and word peach\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #19 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-444.html and word banana\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #20 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-444.html and word coconut\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #21 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-444.html and word apple\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #22 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-444.html and word pear\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #23 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-444.html and word tomato\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #24 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-178.html and word peach\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #25 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-178.html and word banana\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #26 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-178.html and word coconut\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #27 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-178.html and word apple\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #28 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-178.html and word pear\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #29 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-178.html and word tomato\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #30 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-226.html and word peach\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #31 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-226.html and word banana\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #32 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-226.html and word coconut\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #33 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-226.html and word apple\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #34 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-226.html and word pear\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #35 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-226.html and word tomato\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #36 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-196.html and word peach\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #37 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-196.html and word banana\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #38 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-196.html and word coconut\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #39 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-196.html and word apple\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #40 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-196.html and word pear\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #41 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-196.html and word tomato\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #42 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-894.html and word peach\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #43 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-894.html and word banana\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #44 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-894.html and word coconut\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #45 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-894.html and word apple\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #46 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-894.html and word pear\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #47 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-894.html and word tomato\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #48 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-629.html and word peach\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #49 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-629.html and word banana\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #50 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-629.html and word coconut\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #51 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-629.html and word apple\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #52 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-629.html and word pear\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #53 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-629.html and word tomato\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #54 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-259.html and word peach\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #55 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-259.html and word banana\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #56 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-259.html and word coconut\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #57 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-259.html and word apple\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #58 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-259.html and word pear\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #59 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/fruits/N-259.html and word tomato\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #60 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/tinyfruits/N.html and word peach\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #61 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/tinyfruits/N.html and word banana\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #62 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/tinyfruits/N.html and word coconut\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #63 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/tinyfruits/N.html and word apple\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #64 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/tinyfruits/N.html and word pear\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_doubles(expected, result):
  ...
  success_output_file.write('Passed Test #65 checking TF-IDF for URL http://people.scs.carleton.ca/~davidmckenney/tinyfruits/N.html and word tomato\n\n')
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
