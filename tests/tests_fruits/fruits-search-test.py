...
import testingtools
from code import crawler, search

output = open('fruits-search-failed.txt', 'w')
success_output_file = open('fruits-search-passed.txt', 'w')
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #0 checking search results for 'peach apple apple apple banana peach peach banana' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #1 checking search results for 'banana peach tomato tomato pear peach peach' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #2 checking search results for 'pear coconut pear apple banana banana peach' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #3 checking search results for 'tomato apple banana banana tomato banana coconut banana' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #4 checking search results for 'pear coconut coconut apple tomato peach' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #5 checking search results for 'peach coconut' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #6 checking search results for 'peach banana pear pear peach coconut peach banana' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #7 checking search results for 'peach banana pear pear peach coconut peach banana' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #8 checking search results for 'pear coconut peach peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #9 checking search results for 'apple peach apple banana peach coconut' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #10 checking search results for 'tomato banana banana peach coconut tomato peach apple' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #11 checking search results for 'coconut tomato apple peach peach banana' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #12 checking search results for 'tomato peach tomato coconut tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #13 checking search results for 'coconut apple banana pear peach banana' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #14 checking search results for 'peach coconut tomato banana peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #15 checking search results for 'banana apple peach pear banana peach apple' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #16 checking search results for 'coconut coconut peach tomato pear banana' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #17 checking search results for 'peach pear coconut peach banana peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #18 checking search results for 'coconut apple peach banana coconut apple pear tomato' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #19 checking search results for 'pear coconut pear pear coconut pear pear apple' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #20 checking search results for 'tomato coconut tomato tomato pear banana peach peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #21 checking search results for 'apple coconut coconut pear peach tomato' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #22 checking search results for 'tomato pear peach banana coconut pear peach peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #23 checking search results for 'tomato peach peach coconut pear apple coconut' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #24 checking search results for 'peach coconut pear peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #25 checking search results for 'coconut peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #26 checking search results for 'tomato peach apple' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #27 checking search results for 'tomato coconut peach peach pear peach tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #28 checking search results for 'banana apple apple peach apple tomato pear peach' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #29 checking search results for 'coconut peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #30 checking search results for 'coconut peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #31 checking search results for 'tomato apple banana coconut peach tomato peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #32 checking search results for 'peach apple peach coconut apple peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #33 checking search results for 'peach coconut tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #34 checking search results for 'banana peach apple tomato coconut coconut apple pear' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #35 checking search results for 'peach banana pear tomato peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #36 checking search results for 'peach tomato pear tomato tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #37 checking search results for 'apple banana peach peach tomato coconut peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #38 checking search results for 'pear pear pear pear peach coconut' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #39 checking search results for 'coconut peach banana pear apple peach banana banana' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #40 checking search results for 'coconut peach tomato banana banana tomato peach peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #41 checking search results for 'apple tomato banana tomato banana banana banana peach' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #42 checking search results for 'banana peach pear pear peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #43 checking search results for 'peach tomato peach tomato coconut apple banana tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #44 checking search results for 'peach pear peach apple' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #45 checking search results for 'pear peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #46 checking search results for 'peach coconut tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #47 checking search results for 'peach banana tomato peach banana apple tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #48 checking search results for 'coconut coconut coconut tomato apple peach apple' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #49 checking search results for 'banana pear banana peach pear apple peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #50 checking search results for 'tomato banana peach peach tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #51 checking search results for 'tomato coconut peach pear banana banana pear peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #52 checking search results for 'peach apple peach banana coconut apple banana tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #53 checking search results for 'coconut peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #54 checking search results for 'peach banana peach tomato peach coconut' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #55 checking search results for 'peach banana peach tomato peach coconut' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #56 checking search results for 'peach coconut tomato tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #57 checking search results for 'peach banana banana pear banana peach apple coconut' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #58 checking search results for 'peach banana coconut peach peach peach pear' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #59 checking search results for 'coconut peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #60 checking search results for 'banana peach apple tomato peach tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #61 checking search results for 'peach tomato tomato pear banana apple apple' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #62 checking search results for 'pear peach peach apple tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #63 checking search results for 'peach pear coconut peach peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #64 checking search results for 'coconut pear banana coconut peach banana peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #65 checking search results for 'peach tomato banana apple peach tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #66 checking search results for 'pear peach peach coconut tomato tomato apple banana' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #67 checking search results for 'peach apple peach pear tomato pear' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #68 checking search results for 'banana peach pear pear peach' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #69 checking search results for 'pear pear pear apple tomato peach' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #70 checking search results for 'banana banana peach tomato apple pear peach tomato' and boost = True\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #71 checking search results for 'pear tomato banana coconut pear apple banana peach' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #72 checking search results for 'banana peach coconut pear coconut pear tomato coconut' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #73 checking search results for 'peach apple peach apple pear coconut' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #74 checking search results for 'peach peach peach tomato peach coconut pear' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #75 checking search results for 'banana peach coconut banana apple banana' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #76 checking search results for 'pear coconut pear pear banana tomato pear' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #77 checking search results for 'peach peach pear apple tomato peach' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #78 checking search results for 'peach apple pear apple apple' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #79 checking search results for 'peach coconut banana apple apple apple banana pear' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #80 checking search results for 'apple banana tomato apple coconut apple apple banana' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #81 checking search results for 'apple apple peach tomato peach pear peach' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #82 checking search results for 'peach peach coconut peach tomato pear peach apple' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #83 checking search results for 'tomato apple apple apple peach apple apple pear' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #84 checking search results for 'coconut coconut pear coconut coconut banana' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #85 checking search results for 'tomato coconut peach coconut banana coconut tomato' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #86 checking search results for 'banana apple peach tomato coconut coconut pear apple' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #87 checking search results for 'coconut peach coconut coconut apple coconut' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #88 checking search results for 'banana peach pear peach apple peach banana' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #89 checking search results for 'pear tomato coconut coconut coconut peach coconut peach' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #90 checking search results for 'coconut pear peach apple coconut' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #91 checking search results for 'apple coconut banana apple coconut pear' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #92 checking search results for 'apple pear pear coconut coconut pear pear tomato' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #93 checking search results for 'coconut apple apple tomato banana pear coconut' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #94 checking search results for 'apple coconut banana banana apple coconut coconut pear' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #95 checking search results for 'tomato pear banana pear pear peach apple' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #96 checking search results for 'pear peach banana peach coconut tomato peach coconut' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #97 checking search results for 'tomato peach pear apple banana apple' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #98 checking search results for 'coconut tomato coconut coconut peach coconut coconut pear' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
...
if not testingtools.compare_search_results(expected, result):
  ...
  success_output_file.write("Passed Test #99 checking search results for 'tomato peach pear apple coconut coconut apple banana' and boost = False\n\n")
  success_output_file.write('expected = {}\n'.format(str(expected)))
  success_output_file.write('result = {}\n\n\n'.format(str(result)))
